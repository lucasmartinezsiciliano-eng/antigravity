...
from app.api.routes import analysis, barbers, payments
...
async def lifespan(app: FastAPI):
    logger.info("StyleScan API starting — initializing database")
    await init_db()
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"] if settings.DEBUG else ["https://stylescan.app"],
